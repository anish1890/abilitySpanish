...
class SubCategoryLearnVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var subCatListCollectionView: UICollectionView!
    
    var arrDataAlphabets: [Any] = []
    var passArrDataSelected: [Any] = []
    var arrSelectedItem: [String] = ["Alfabetos", "Números", "Colores", "Formas", "Animales", "Aves", "Flores", "Frutas", "Mes", "Vegetales", "Partes del Cuerpo", "Ropa", "País", "Comida", "Geometría", "Casa", "Trabajos", "Escuela", "Deportes", "Vehículo"]
    ...
    override func viewDidLoad() {
        ...
        subCatListCollectionView.register(collectionNib, forCellWithReuseIdentifier: "CategoryCollectionViewCell")
        
        title = arrSelectedItem[selectedSubCat]
        
        switch selectedSubCat {
        case 0: alphabetDetailsArray()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.mainCatView.backgroundColor = UIColor.white

        cell.mainCatImg.image = UIImage(named: arrGetSubCatData[indexPath.row] as! String)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "subCatDetailsVC") as! SubCatDetailsVC
        vc.selectedSubCatIndex = indexPath.row
        vc.arrGetSubCatDetailsData = passArrDataSelected
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if UIDevice.current.userInterfaceIdiom == .phone {
            return CGSize(width: subCatListCollectionView.frame.size.width / 2, height: subCatListCollectionView.frame.size.width / 2)
        } else {
            return CGSize(width: subCatListCollectionView.frame.size.width / 4, height: subCatListCollectionView.frame.size.width / 4)
        }
    }
