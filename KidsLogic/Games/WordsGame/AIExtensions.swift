...
extension UIFont {
    ...
    class func appFont_Poppins_Regular_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Poppins-Regular", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
    
    class func appFont_Poppins_Light_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Poppins-Light", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
    
    class func appFont_Poppins_Medium_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Poppins-Medium", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
    
    class func appFont_Poppins_SemiBold_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Poppins-SemiBold", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
    
    class func appFont_Poppins_Bold_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Poppins-Bold", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
    
    class func appFont_Square721BT_Bold_WithSize(_ fontSize : CGFloat) -> UIFont {
        return UIFont(name: "Square721BT-Bold", size: fontSize.proportionalFontSize()) ?? UIFont()
    }
...
extension UIViewController {
    func showInputDialog(title:String? = nil,
        ...
        alert.setValue(NSAttributedString(string: title!, attributes: [NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 16),NSAttributedString.Key.foregroundColor : APP_GREY]), forKey: "attributedTitle")
